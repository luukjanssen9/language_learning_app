...
Status: early scaffolding (Phase 0). See [PLAN.md](./PLAN.md) for the full
build plan, current status, and decisions log.

Full setup instructions, architecture overview, and screenshots will land
here as the project is built out (Phase 8).
